//#include "devices/DeviceCommand_Server.h"
//
//#include <QStringList>
//#include <QVariantMap>
//
...
//
//DeviceCommand_Server::DeviceCommand_Server(QObject *parent)
...
//}
//
//DeviceCommand_Server::DeviceCommand_Server(const QString &name,
//                                       const QString &method,
//                                       const QString &path,
//                                       QObject *parent)
//    : DeviceCommand_Server(name, QString(), method, path, parent)
//{
//}
//
//DeviceCommand_Server::DeviceCommand_Server(const QString &name,
...
//}
//
//QString DeviceCommand_Server::address() const
//{
//    return m_address;
//}
//
//void DeviceCommand_Server::setAddress(const QString &address)
//{
...
//}
//
//QString DeviceCommand_Server::method() const
//{
//    return m_method;
//}
//
//void DeviceCommand_Server::setMethod(const QString &method)
//{
...
//}
//
//QString DeviceCommand_Server::path() const
//{
//    return m_path;
//}
//
//void DeviceCommand_Server::setPath(const QString &path)
//{
...
//}
//
//QString DeviceCommand_Server::body() const
//{
//    return m_body;
//}
//
//void DeviceCommand_Server::setBody(const QString &body)
//{
//    if (m_body == body)
//        return;
//
...
//}
//
//QString DeviceCommand_Server::protocol() const
//{
//    return protocolName();
//}
//
//QString DeviceCommand_Server::protocolName()
//{
//    return QStringLiteral("http");
//}
//
//QJsonObject DeviceCommand_Server::paramsToJson() const
//{
//    QJsonObject params;
...
//}
//
//bool DeviceCommand_Server::loadParamsFromJson(const QJsonObject &params)
//{
...
//}
//
//QString DeviceCommand_Server::validateParams() const
//{
...
//}
//
//QList<DeviceParamSpec *> DeviceCommand_Server::createCreationInputFields(QObject *parent) const
//{
